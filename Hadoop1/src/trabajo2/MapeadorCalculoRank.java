...
public class MapeadorCalculoRank extends Mapper<LongWritable, Text, Text, Text> {
    @Override
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        System.out.println("map22Page:"+page+"...pageWithRank:"+pageWithRank);
        ...
        System.out.println("map22page:"+page+"...links:"+links);
    }
}
