...
public class MapeadorRanking extends Mapper<LongWritable, Text, FloatWritable, Text> {
    @Override
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        String[] pageAndRank = getPageAndRank(key, value);
        System.out.println("map33pageAndRank[0]:"+pageAndRank[0]+"...pageAndRank[1]:"+pageAndRank[1]);
